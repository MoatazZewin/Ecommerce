...
class KidFragment : Fragment() ,CategoryAdapter.OnItemClickListener{
    ...
    private lateinit var kidFilterFragment: KidFilterFragment
    var clicked = false
    ...
    override fun onViewCreated(view: View,savedInstanceState: Bundle?) {
        ...
        _binding.tshirtFloating.setOnClickListener{
            ...
            kidFilterFragment=  KidFilterFragment()
            kidFilterFragment.arguments = bundle
            activity?.supportFragmentManager?.beginTransaction()
                ?.replace(R.id.fragment_container,kidFilterFragment )?.commit()
        }
